...
-- 문의 테이블
CREATE TABLE board (
    bid NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    title VARCHAR2(200) NOT NULL,
    content VARCHAR2(2000) NOT NULL,
    writer NUMBER NOT NULL,
    category VARCHAR2(20) NOT NULL CHECK (category IN ('예금', '대출', '카드')),
    isAnswered CHAR(1) DEFAULT 'N' CHECK (isAnswered IN ('Y', 'N')),  // 추가
    CONSTRAINT fk_board_writer FOREIGN KEY (writer) REFERENCES member98(mid)
);
...
CREATE TABLE answer (
    ...
    CONSTRAINT fk_answer_writer FOREIGN KEY (writer) REFERENCES member(mid),
    CONSTRAINT fk_answer_board FOREIGN KEY (board_id) REFERENCES board(bid)
);
```
